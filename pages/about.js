            ...
            <section className="my-20 text-center">
                ...
                <p className=" text-gray-400 dark:text-gray-400 lg:mx-96 sm:mx-10">
                    ...
                    I love to do 3D renders using <Link href={'https://www.blender.org/'}><a className="underline">Blender.</a></Link>
                     In my free time, I enjoy writing content on <Link href={'https://medium.com/@tarungudipalli'}><a className="underline">Medium</a></Link> and building custom templates for <Link href={'https://tarungudipalli.gumroad.com/l/qqpwa'}><a className="underline">Notion</a></Link> to help others streamline their workflow.
                </p>
            </section>
